...
```
User: /owflow:reviews-pragmatic .owflow/tasks/development/2025-11-17-user-management/
```

**Example 2**: Review source directory

```
User: /owflow:reviews-pragmatic src/features/payments/
```

**Example 3**: Review specific file

```
User: /owflow:reviews-pragmatic src/services/cache-service.ts
```
