...
description: Development — codebase analysis, clarifications, gap analysis & scope decisions
argument-hint: "[task-path-or-identifier]"
---

CRITICAL INSTRUCTION: You MUST invoke the owflow:dev-analyze skill immediately as your FIRST action.
...
WHY: The user explicitly chose this workflow phase by using /owflow:dev-analyze.
...
Part of the development workflow. See `skills/dev-analyze/SKILL.md` for complete phase documentation.
