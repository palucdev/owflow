...
description: Development — verification options, implementation verification & fix loop
...
WHY: The user explicitly chose this workflow phase by using /owflow:dev-verify.
...
Part of the development workflow. See `skills/dev-verify/SKILL.md` for complete phase documentation.
