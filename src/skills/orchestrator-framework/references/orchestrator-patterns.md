...
Some heavily cross-referenced sections live in their own reference files:

- [Delegation Rules](delegation-rules.md) — Skill/Task tool delegation contract (was Section 1)
